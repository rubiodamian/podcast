...
abstract class BaseSfGuardUserGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  'User' =>   array(    0 => 'first_name',    1 => 'last_name',    2 => 'email_address',    3 => 'username',    4 => 'password',    5 => 'password_again',  ),  'Permissions and goups' =>   array(    0 => 'is_active',    1 => 'permissions_list',  ),);
  }
