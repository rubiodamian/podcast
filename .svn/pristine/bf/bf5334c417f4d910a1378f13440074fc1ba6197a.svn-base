...
abstract class BasePodcastFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'categoria_idCategoria' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('categoria'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'categoria_idCategoria' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('categoria'), 'column' => 'idCategoria')),
  ...
  public function getFields()
  {
    return array(
      ...
      'publicado'             => 'Boolean',
      'imagen'                => 'Text',
      'categoria_idCategoria' => 'ForeignKey',
      'user_id'               => 'ForeignKey',
      'created_at'            => 'Date',
      'updated_at'            => 'Date',
    );
